	...
	app: {
		head: {
			...
			link: [
				...
				// 站点背景图为 LCP 元素，但由 CSS 引入导致发现过晚，此处提前声明
				{ rel: 'preload', as: 'image', href: '/assets/Yuki.webp', fetchpriority: 'high' },
